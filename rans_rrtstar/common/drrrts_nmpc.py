...
def nmpc(N,T, rrt_states, rrt_inputs, num_steps, num_states, num_inputs,
    ...
    return disturbed_nmpc(N, T, rrt_states, rrt_inputs, num_steps,
                          num_states, num_inputs, w, obstaclelist, envbounds, drnmpc, hnmpc=hnmpc)

def disturbed_nmpc(N,T, rrt_states, rrt_inputs, num_steps, num_states, num_inputs, w, obstaclelist, envbounds, drnmpc=True, hnmpc=True):
